        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="row">
                    <strong>充值金额：</strong><input type="text" class="money" value="{{$discount->money}}"><br/><br/>
                    <strong>赠送条数：</strong><input type="text" class="discount_num" value="{{$discount->discount_num}}"><br/><br/>
                    <a target="_self" href="javascript:;" id="sub" class="btn btn-primary btn-sm">保存</a>
                    <a target="_self" href="{{url('/admin/discount/del')}}?id={{$discount->id}}" id="sub" class="btn btn-primary btn-sm">删除</a>
                    </div> 
                </div>
            </div>
        </div>
